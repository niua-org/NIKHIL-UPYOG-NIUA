...
import { Card, Loader, PopUp, SearchAction } from "@upyog/digit-ui-react-components";
...
export const ApplicationCard = ({
  ...
  if (!data || data?.length === 0) {
    ...
    result = <DetailsCard data={data} serviceRequestIdKey={serviceRequestIdKey} linkPrefix={"/upyog-ui/employee/challangeneration/application/"} />;
  }
