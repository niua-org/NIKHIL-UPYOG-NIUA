...
export function ArrowUpwardElement(marginRight, marginLeft) {
  return <Arrow_Upward style={{ display: "inline-block", verticalAlign: "baseline", marginRight: !marginRight ? "0px" : marginRight, marginLeft: !marginLeft ? "0px" : marginLeft }} />;
}
